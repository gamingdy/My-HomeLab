...
**Important**: Update the Traefik dashboard domain. Change `proxy.example.com` to your desired domain:

<ShowCode url="traefik/compose.yaml" language="yml" title="compose.yml" lineStart={17} lineEnd={23} collapse="1-5,7-9" mark="proxy.example.com" isGithub />
